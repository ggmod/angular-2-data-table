...
<div class="pagination-box">
    ...
    <div class="pagination-controllers">
        ...
        <div class=" pagination-pages">
            ...
            <button *ngIf="hasPrevious(maxPage,page)" [disabled]="true" (click)="false" class="btn btn-default">...</button>
            ...
            <button *ngIf="hasNext(maxPage,page)" [disabled]="true" (click)="false" class="btn btn-default">...</button>
